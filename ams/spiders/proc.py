...
class ProcSpider(scrapy.Spider):
    ...
    def parse_article(self,response):
        ...
        # author_list = response.xpath('//head/meta[@name="citation_author"]/@content').extract()
        # if author_list:
        #     authors = []
        #     for i in range(len(author_list)):
        #         dic = {}
        #         dic['name'] = author_list[i]
        #         dic['pos'] = i
        #         if response.xpath('//head/meta[@name="citation_author_institution"][{}]/@content'.format(i+1)).extract_first():
        #             dic['org']=response.xpath('//head/meta[@name="citation_author_institution"][{}]/@content'.format(i+1)).extract_first()
        #         if response.xpath('//head/meta[@name="citation_author_email"][{}]/@content'.format(i+1)).extract_first():
        #             dic['email']=response.xpath('//head/meta[@name="citation_author_email"][{}]/@content'.format(i+1)).extract_first()
        #         authors.append(dic)
