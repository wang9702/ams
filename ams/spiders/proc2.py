...
class ProcSpider(scrapy.Spider):
    ...
    start_urls = ['https://www.ams.org/journals/proc/all_issues.html']
    header = {
        'User-Agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/75.0.3770.100 Safari/537.36',
        'Cookie':'cookieconsent_status=dismiss; AMS_BP37qb3Zu9=9e4068c4.59822c8586aa4',
        'Host':'www.ams.org'
    }
    # with open(r'E:\.metadata\PROCEEDINGS_OF_THE_AMERICAN_MATHEMATICAL_SOCIETY.json','r',encoding='utf-8') as f:
    #     file=f.read()
    ...
    def __init__(self):
        ...
        self.MONGO_TABLE = 'PROCEEDINGS'
    def start_requests(self):
        for year in range(2019,2021):#1995
            volume=year-1872
            vol=str(volume)
    ...
    def parse_article(self,response):
        ...
        if doi:
            ...
            item['sid']='/'.join(response.url.split('/')[-3:])
